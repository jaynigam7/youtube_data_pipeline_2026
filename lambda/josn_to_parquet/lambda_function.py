...
GLUE_DB = os.environ.get("GLUE_DB_SILVER", "yt_pipeline_silver_jay")
GLUE_TABLE = os.environ.get("GLUE_TABLE_REFERENCE", "clean_reference_data")
SNS_TOPIC = os.environ.get("SNS_ALERT_TOPIC_ARN", "")
SILVER_PATH = f"s3://yt-data-pipeline-silver-ap-south-1jay/youtube/reference_data/"
    ...
    for record in records:
        try:
            ...
            wr_response = wr.s3.to_parquet(
                df=df,
                path="yt-data-pipeline-silver-ap-south-1jay",
                dataset=True,
                database=GLUE_DB,
                table=GLUE_TABLE,
